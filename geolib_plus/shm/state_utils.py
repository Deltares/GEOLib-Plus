...
class StateUtils(BaseModel):
    ...
    def calculate_yield_stress_prob_parameters_from_cpt(effective_stress: float, q_net: float, mu_S: float, mu_m: float,
                                                        mean_nkt: float, vc_q_net_nkt: float) -> (float, float):
        """
    ...
    @staticmethod
    def calculate_pop_prob_parameters_from_cpt(effective_stress: float, q_net: float, mu_S: float, mu_m: float,
                                                        mean_nkt: float, vc_q_net_nkt: float) -> (float, float):
        """
        ...
        mu_yield, sigma_yield = StateUtils.calculate_yield_stress_prob_parameters_from_cpt(effective_stress, q_net,
                                                                                           mu_S, mu_m, mean_nkt,
                                                                                           vc_q_net_nkt)
    ...
    @staticmethod
    def calculate_ocr_prob_parameters_from_cpt(effective_stress: float, q_net: float, mu_S: float, mu_m: float,
                                                        mean_nkt: float, vc_q_net_nkt: float) -> (float, float):
        """
    ...
    @staticmethod
    def calculate_characteristic_yield_stress(effective_stress: float, current_effective_stress: float,
    ...
    @staticmethod
    def calculate_characteristic_pop(effective_stress: float, current_effective_stress: float,
                                              q_net: float, kar_S: float, kar_m: float, char_nkt) -> float:
        """
