...
class GefFileReader:
    ...
    def read_gef(self, gef_file: Path, fct_a: float = 0.8) -> Dict:
        ...
        return dict(
            ...
            inclination_ns=np.array(self.property_dict["inclination_ns"].values_from_gef),
            inclination_ew=np.array(self.property_dict["inclination_ew"].values_from_gef),
            ...
            unit_weight_measured=np.array(self.property_dict["unit_weight"].values_from_gef),
            pwp_ini=np.array(self.property_dict["pwp_ini"].values_from_gef),
            total_pressure_measured=np.array(self.property_dict["total_pressure"].values_from_gef),
            effective_pressure_measured=np.array(self.property_dict["effective_pressure"].values_from_gef),
            electric_cond=np.array(self.property_dict["electric_cond"].values_from_gef),
            magnetic_strength_x=np.array(self.property_dict["magnetic_strength_x"].values_from_gef),
            magnetic_strength_y=np.array(self.property_dict["magnetic_strength_y"].values_from_gef),
            magnetic_strength_z=np.array(self.property_dict["magnetic_strength_z"].values_from_gef),
            magnetic_strength_tot=np.array(self.property_dict["magnetic_strength_tot"].values_from_gef),
            magnetic_inclination=np.array(self.property_dict["magnetic_inclination"].values_from_gef),
            magnetic_declination=np.array(self.property_dict["magnetic_declination"].values_from_gef),
