...
class TestNktUtils:
    ...
    def test_calculate_pop_prob_parameters_from_cpt(self):
        ...
        """
        mean_pop, std_pop = StateUtils.calculate_pop_prob_parameters_from_cpt(
            15.8, 180, 0.38, 0.8, 16.01, 0.169
        )
    ...
    def test_calculate_ocr_prob_parameters_from_cpt(self):
        ...
        """
        mean_ocr, std_ocr = StateUtils.calculate_ocr_prob_parameters_from_cpt(
            15.8, 180, 0.38, 0.8, 16.01, 0.169
        )
    ...
    def test_calculate_characteristic_yield_stress(self):
        ...
        char_yield_stress = StateUtils.calculate_characteristic_yield_stress(
            15.8, 15.8, 180, 0.37, 0.8, 20.8
        )
    ...
    def test_calculate_characteristic_pop(self):
        ...
        char_pop = StateUtils.calculate_characteristic_pop(
            15.8, 15.8, 180, 0.37, 0.8, 20.8
        )
    ...
    def test_calculate_characteristic_pop(self):
        ...
        char_ocr = StateUtils.calculate_characteristic_ocr(
            15.8, 15.8, 180, 0.37, 0.8, 20.8
        )
