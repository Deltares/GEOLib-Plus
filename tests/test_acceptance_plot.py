...
class TestPlotAcceptance:
    ...
    def test_plot_bro_xml_cpt_various_formats(self):
        """Test plotting Bro XML CPT files with various formats."""

        cpt_folder_xml = TestUtils.get_local_test_data_dir(
            "cpt/bro_xml/xmls_with_various_formats"
        )
        # Find all xml files in the directory
        for cpt_file_xml in cpt_folder_xml.glob("*.xml"):
            print(f"Processing file: {cpt_file_xml}")
